...
namespace Perspective\Theme19DynamicallySchedule\Model\Config;

class CronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/perspective_theme19dynamicallyschedule_cron_job/schedule/cron_expr';

    const CRON_MODEL_PATH = 'crontab/default/jobs/perspective_theme19dynamicallyschedule_cron_job/run/model';
